...
if (process.argv[1] === fileURLToPath(import.meta.url)) { const port = Number(process.env.PORT || 3000); makeApp().listen(port, () => console.log(`STACK running at http://localhost:${port}`)); }
